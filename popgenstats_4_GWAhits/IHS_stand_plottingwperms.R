...
sex<-fread("~/nonbinary_twocovs_n155.assoc.txt",header=T) #full observed GWA results
hdr<-names(sex)
...
#STANDARDIZE
stand<-read.table("standardized_ihs_popperm.txt",skip = 1) #expected IHS values by AF, generated by selscan norm
names(ihs_obs)
